    ...
    <table id="zero_config" class="table table-striped table-bordered text-center">
        ...
        <tbody>
            <?php
                ...
                <input type="hidden" value="<?php echo $ced;?>" id="ced<?php echo $id;?>">    
            ...
            <tr>
                ...
                <td style="text-align: center; white-space: nowrap;">
                    <button type="button" class="btn btn-success" title='Detalles' onclick="detalles('<?php echo $id;?>');" data-toggle="modal" data-target="#ddocInfo"><i class="nav-icon fas fa-edit"></i> Editar</button>                    
                </td>
            </tr>
            <?php
                }
