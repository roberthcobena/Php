<?php    
    ...
    if($action == 'ajax'){
        ...
        $sWhere = "";
        $sWhere.=" WHERE t.esta_taller='1' AND u.id_unidad=e.id_unidad AND e.id_tema=t.tema_taller AND t.curs_taller=c.id_curso AND c.jornada=j.id_seccion AND c.id_curso=$id_curso";
    if ( $_GET['q'] != "" ){
            ...
            <tr>
                ...
                $date = date("Y-m-d H:i:s", $time);                                       
                    ...
                    if ($result = mysqli_query($con, $sql3)) {
                        ...
                        if (empty($row_cnt)) {
                            if ($date <= $row['inicio_t']) {
                                ?>
                                 <a href="#" onclick="" class='btn btn-success disabled' title='Realizar taller'><i class="nav-icon fas fa-edit"> No disponible aun</i></a>
                                 <?php
                            }elseif ($date >= $row['inicio_t'] && $date <= $row['fin_t']) {
                                ?>
                                ...
                                if ($acce==1) {
                                    ...
                                    ?>
                                    <a href="#" onclick="" class='btn btn-success disabled' title='Realizar taller'><i class="nav-icon fas fa-edit"> Taller Expirado</i></a>
                                    <?php
                                }
                            }
