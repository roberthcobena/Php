...
<div class="card-body table-responsive p-0">
    <table id="zero_config" class="table table-striped table-bordered text-left">
        <thead>
            <tr>
                <th colspan="9" class="bg bg-cyan text-white"><b>Respuestas registradas</b></th>            
            </tr>
            <tr>
                <th>#</th>
                <th>Pregunta</th>            
        ...
        ?>
            ...
            <tfoot>
                <tr>
                    <?php
                    $consul1 = "SELECT * FROM alumno_taller WHERE  id_taller = $id_taller AND id_alumno = $id_al";
                    $result1 = mysqli_query($con, $consul1);
                    $row1 = mysqli_fetch_array($result1);
                    $nota = $row1 ['prom_taller'];
                    ?>
                    <th colspan="9" style="text-align: right;"><b>NOTA OBTENIDA EN EL TALLER: <?php echo $nota ."/10"?></th></b>
                </tr>      
            </tfoot>
        </tbody>
    </table>
