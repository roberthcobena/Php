            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" id="edita_curso" name="edita_curso" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control curso-inputmask" id="m_curso" name="m_curso">                            
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="m_año" class="col-sm-3 text-right control-label col-form-label">Año lectivo: </label>
                        <div class="col-sm-9">
                            <select class="form-control" id="m_año" name="m_año"  required>
                                <option value="">-- Selecciona --</option>
                                <?php
