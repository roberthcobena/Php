            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" method="post" id="nuevo_matricula" name="nuevo_matricula" enctype="multipart/form-data">
                    <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control codigo-inputmask" id="m_cod" name="m_cod" placeholder="Codigo">                            
                            </div>
                        </div>                    
                    </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                            <button type="submit" class="btn btn-primary" id="nuevo_Matri">Matricularse</button>
                        </div>
