...
if ($tipo==1 OR $cargo==1) {
    $sql3 = "SELECT c.id_curso, c.nom_curso, c.sec_curso, j.nom_seccion, a.anio FROM cursos c, jornadas j, anios_lectivos a WHERE c.jornada=j.id_seccion AND a.id=c.an_lec";
