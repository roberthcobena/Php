            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" id="nueva_unidad" name="nueva_unidad" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="unidad" name="unidad" onkeypress="return check(event)" required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="descripcion" name="descripcion" onkeypress="return check(event)" required=""></textarea>
                        </div>
                    </div>
