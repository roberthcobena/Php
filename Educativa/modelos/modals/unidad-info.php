...
<div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" id="edita_uni" name="edita_uni" enctype="multipart/form-data">
                    <!-- Variable oculta -->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="m_unidad" name="m_unidad" onkeypress="return check(event)" required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="m_descripcion" name="m_descripcion" onkeypress="return check(event)" required=""></textarea>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="edita_Unidad">Guardar</button>
                </div>
                <div id="resultados_ajax_i"></div>
            </form>
        </div>
    </div>
</div> 