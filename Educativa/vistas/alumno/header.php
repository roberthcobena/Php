<?php
    ...
    while ($row = mysqli_fetch_array($query)) {
        if (!empty($row['nomb_user'])) {
            $nombre = $row['nomb_user'];        
        }
        if (!empty($row['apell_user'])) {
                    ...
                    <ul class="navbar-nav float-right">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">                        
                                <a class="dropdown-item" href="perfil.php"><i class="fa fa-user m-r-5 m-l-5"></i> Editar perfil</a>
                                <a class="dropdown-item" href="../../recursos/archivos/Manual - sistema web estudiante.pdf"  target="_blank"><i class="fa fa-question m-r-5 m-l-5"></i> Ayuda</a>
