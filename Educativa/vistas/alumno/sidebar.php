    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="p-t-30">
                ...
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="curso.php" aria-expanded="false"><i class="mdi mdi-book"></i><span class="hide-menu">Curso</span></a></li>
