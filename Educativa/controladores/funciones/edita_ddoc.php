	...
	if (empty($_POST['m_id'])) { //validamos que no este vacío el campo
       $errors[] = "Falta id del docente"; //mensaje en caso de error
		...
		$sql="UPDATE usuario u
				...
				SET d.nomb_user='$nombre', d.apell_user='$apellido', d.telf_user='$telf', d.correo_user='$correo', o.doc_titulo='$titulo', o.doc_cargo='$cargo', u.u_usuario='$usuario', u.u_contra='$clave',o.doc_estado='$estado', u.u_estado='$estado', d.esta_user='$estado' WHERE o.id_docente='$id_user'";
