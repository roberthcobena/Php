<?php 
	if(empty($_POST['curso'])) {
	   ...
	   $errors[] = "Falta jornada del curso";
		...
		$errors[] = "Falta año lectivo del curso";
    ...
    $sql = "SELECT * FROM cursos WHERE nom_curso = '" . $curso . "' AND sec_curso = '" . $seccion . "' AND jornada = '" . $jornada . "' AND an_lec = '" . $año . "'";
    $query_check_user_name = mysqli_query($con,$sql);
	$query_check_user=mysqli_num_rows($query_check_user_name);
    if($query_check_user == 1) {
        $errors[] = "El curso ya existe.";
    } else { // SI NO EXISTE SE CREA
    $sqli="INSERT INTO cursos (nom_curso, cod_curso, sec_curso, jornada, an_lec) VALUES ('$curso','$cod_curso','$seccion','$jornada','$año')";
