                ...
                <!-- CONTRASEÑA DE USUARIO -->
                    <form class="form-horizontal" form method="post" id="contra_usuario">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                            <input type="password" maxlength="100" class="form-control" name="grado_inv" required >
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="grado_inv" class="col-sm-6 control-label">Repetir contraseña</label>
                        ...
                        <div class='col-md-12' id="resultados_ajax_Contra">asd</div><!-- Carga los datos ajax -->
                    </form>
                </div>
            </div>
        </div>
