    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
            ...
            <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="docest.php" id="navbarDropdown" role="button"  aria-haspopup="true" aria-expanded="false">                             
                             <span class="d-block d-md-none"><i class="mdi mdi-arrow-left-drop-circle-outline"></i>volver</span>   
                            </a>
