                    ...
                    <!-- DATOS DE USUARIO -->
                        <form class="form-horizontal" form method="post" id="datos_usuario">
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="30" class="form-control" name="nombre" value="<?php echo $nombre?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                <input type="text" maxlength="30" class="form-control" name="apellido" value="<?php echo $apellido?>" required>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                <input type="E-mail" maxlength="50" data-validation="email" class="form-control" name="correo" value="<?php echo $correo?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                <input type="text" maxlength="100" class="form-control" name="telefono" value="<?php echo $telefono?>" required>
                                </div>
                            </div>                   
