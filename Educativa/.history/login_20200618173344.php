...
<body>
   ...
   <form method="post" action="abrirsesion.php">
      ...
      <input type="password" name="pass" class="btn btn-success" id="pass" placeholder="Ingresar Contraseña" /></br></br>
      <input type="submit" id="entrar" name="entrar" value="Ingresar" class="boton"></br></br>
      <input type="submit" id="regresar" name="regresar" value="Regresar" class="boton"></br></br>
