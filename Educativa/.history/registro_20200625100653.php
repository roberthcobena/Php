...
<body>
   ...
   <?php				
      ...
      <button type="submit" class="btn btn-primary btn-block" name="login" id="submit">REGISTRARME</button></br></br>
      <a href="index.php">Regresar a página principal</a></br></br></br></br></br></br>
      ¿Tienes una cuenta?<a href="login.php" style="font-family:'Play', sans-serif;">&nbsp;INICIAR SESIÓN</a>
   </form>
</div>
</body>
</html>
