...
<body>    
    ...
    <div id="main-wrapper">        
        ...
        <div class="page-wrapper">            
                    ...
                    <div class="col-12 d-flex no-block align-items-center">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="admin.php">Perfil</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            include "../vistas/perfil_admin.php";
            //FIN DE CONTENIDO DE LA SECCIÓN
    ...
    <script src="../controladores/js/perfil_admin.js"></script>
    <!-- JQuery -->
