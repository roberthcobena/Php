...
<body>    
    ...
    <div id="main-wrapper">
        <?php
        include "../../vistas/docente/header_1.php";
        ?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" title='Añadir' data-toggle="modal" data-target="#preguNew"><i class="nav-icon fas fa-plus"></i> Añadir taller</button>
    ...
    <script type="text/javascript" src="../../controladores/js/preguntas.js"></script>
