                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" title='Añadir' data-toggle="modal" data-target="#talNew"><i class="nav-icon fas fa-plus"></i> Añadir taller</button>
                                    ...
                                    <form class="form-horizontal" role="form" id="usuarios">                                    
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    ...
                                                    <input type="hidden" value="<?php echo $id_curso;?>" id="id<?php echo $id_curso;?>">
                                                </div>
