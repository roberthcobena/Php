                    ...
                    <div class="col-12">                            
                        <div class="card">                        
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" title='Añadir' onclick="nuevo();" data-toggle="modal" data-target="#cursoNew"><i class="nav-icon fas fa-plus"></i> Añadir </button>
                            ...
                            <div class="card-body">
                                ...
                                <label for="q" class="col-md-2 control-label">Buscar</label>                                     
                                    <div class="col-md-7">
                                    <input type="text" class="form-control btn btn-default" id="q" placeholder="" onkeyup='load(1);'>
                                    </div>
