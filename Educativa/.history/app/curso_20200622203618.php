                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <?php 
                                            include "../modelos/tablas/estudiante.php"
                                            ?>
                                    </div>
                    ...
                    <div class="col-md-12">                       
                        <div class="card">
                            <div class="card-tools">
                                <button style="display:<?php echo $aut_rol; ?>;" type="button" class="btn btn-tool" title='Añadir' onclick="nuevo();" data-toggle="modal" data-target="#cursoNew"><i class="nav-icon fas fa-plus"></i> Añadir </button>
