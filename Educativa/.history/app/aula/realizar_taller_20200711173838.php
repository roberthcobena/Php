<?php   
    ...
    $sql2 = "SELECT * from usuario u, datos_usuarios d, alumno_taller al where al.id_alumno=u.id_usuario AND al.id_taller=$id_taller u.id_usuario=$id_alumno AND d.id_usuario=u.id_usuario";
