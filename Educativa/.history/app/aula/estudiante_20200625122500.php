<?php	
    ...
    $sql = "SELECT * from usuario u, datos_usuario d where u.id_usuario=$id AND d.id_usuario=u.id_usuario";
                    ...
                    <div class="col-12">                            
                        <div class="card">                        
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" title='Añadir' data-toggle="modal" data-target="#cursoNew"><i class="nav-icon fas fa-plus"></i> Nueva Matricula </button>
