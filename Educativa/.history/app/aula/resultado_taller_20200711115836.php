                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-tools">                            
                                <H2>RESULTADOS OBTENIDOS ESTUDIANTE: <?php echo $estudiante;  ?></H2><button type="button" class="btn btn-tool" title="Refrescar" onclick="load(1);"><i class="fas fa-sync-alt"></i> Actualizar</button>                                                  
                            </div>
                            <div class="card-body">                                
