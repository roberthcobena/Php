                            ...
                            <div class="card-body">
                                ...
                                <center>
                                    <div class="form-group row"> 
                                        <label type="hidden"for="q" class="col-md-2 control-label">Buscar</label>                                     
                                        <div class="col-md-7">
                                            <input type="hidden" class="form-control" id="q" placeholder="Nombre de unidad" onkeyup='load(1);'>
                                        </div>
                                        <div class="col-md-3">                      
                                            <span id="loader"></span>
                                        </div>                        
