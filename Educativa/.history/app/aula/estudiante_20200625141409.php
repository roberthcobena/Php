                    ...
                    <div class="col-12">                            
                        <div class="card">                        
                            ...
                            <div class="card-tools">
                                ...
                                <input type="hidden" value="<?php echo $id;?>" id="id_user<?php echo $id;?>">

                                <button type="button" class="btn btn-tool" title='Añadir' onclick="nueva_matric('<?php echo $id;?>');"data-toggle="modal" data-target="#matriNew"><i class="nav-icon fas fa-plus"></i> Nueva Matricula </button>
