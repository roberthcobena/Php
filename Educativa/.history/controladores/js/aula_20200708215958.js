...
//GESTIÓN
function gestion(id) {
    VentanaCentrada('./talleres/gestion_taller.php?id_taller=' + id, 'Taller', '', '1024', '768', 'true');
}
//RESULTADOS
function resultados(id) {
    VentanaCentrada('./talleres/resultado_taller.php?id_taller=' + id, 'taller', '', '1024', '768', 'true');
}