...
$("#nuevo_matricula").submit(function() { //NOMBRE DEL FORM
    ...
    $.ajax({
        ...
        success: function(datos) {
            ...
            load(1);
            setTimeout(esconde_modal_matri, 1000); //LLAMAMOS A FUNCIÓN QUE ESCONDE MODAL, TIEMPO (1000 = 1 SEGUNDO)
...
function actualizar() { window.locationf = "../../app/aula/estudiante.php"; }
