<?php
	if ((!empty($_GET['id_c'])) &&
		...
		//respuestas
		$resp1 =	intval($_GET['p1']);
		$resp2 =	intval($_GET['p2']);
		$resp3 =	intval($_GET['p3']);
		$resp4 =	intval($_GET['p4']);
		$resp5 =	intval($_GET['p5']);
		$resp6 =	intval($_GET['p6']);
		$resp7 =	intval($_GET['p7']);
		$resp8 =	intval($_GET['p8']);
		$resp9 =	intval($_GET['p9']);
		$resp10 =   intval($_GET['p10']);
