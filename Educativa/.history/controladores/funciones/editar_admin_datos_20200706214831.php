	...
	if (empty($_POST['id_d'])) { //validamos que no este vacío el campo
       $errors[] = "Falta id del usuario"; //mensaje en caso de error
        ...
        //mensajes de exito o error
			...
			$errors []= "Error desconocido." . $sql="UPDATE datos_usuarios SET nomb_user='".$nombre."', apell_user='".$apellido."', telf_user='".$telf."', correo_user='".$correo."' WHERE id_usuario='".$id_user."' ";;
		}
