<?php
	if ((!empty($_GET['id_c'])) &&
		...
		//respuestas
		$resp1 =	intval($_GET['resp1']);
		$resp2 =	intval($_GET['resp2']);
		$resp3 =	intval($_GET['resp3']);
		$resp4 =	intval($_GET['resp4']);
		$resp5 =	intval($_GET['resp5']);
		$resp6 =	intval($_GET['resp6']);
		$resp7 =	intval($_GET['resp7']);
		$resp8 =	intval($_GET['resp8']);
		$resp9 =	intval($_GET['resp9']);
		$resp10 = intval($_GET['resp10']);
