<?php	
	if (empty($_POST['mod_id_obj'])) { //validamos que no este vacío el campo
       $errors[] = "Id de objetivo"; //mensaje en caso de vacío
    }else if (
		!empty($_POST['mod_id_obj'])  //si hay algo se procede
	){
		/* Connect To Database*/
