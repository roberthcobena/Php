        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" id="nuevo_curso" name="nuevo_curso" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label for="m_seccion" class="col-sm-3 text-right control-label col-form-label">Sección: </label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="m_seccion" class="col-sm-3 text-right control-label col-form-label">Jornada: </label>
                        <div class="col-sm-9">
                            <select class="form-control" id="m_seccion" name="m_seccion"  required>
                                <option value="">-- Selecciona --</option>
                                <?php
