    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="curso" name="curso" require>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="seccion" name="seccion" data-validation="required" data-validation-error-msg="Seleccione una sección para el curso" require>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="jornada" name="jornada" data-validation="required" data-validation-error-msg="Seleccione una jornada para el curso">
                                <option value="">-- Seleccione --</option>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="guarda_Curso">Guardar</button>
            </div>
        </div>
    </div>
</div>            