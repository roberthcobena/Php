        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" id="edita_curso" name="edita_curso" enctype="multipart/form-data">
                    ...
                    <label for="m_cod" class="col-sm-2 text-right control-label col-form-label">Unidad: </label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group row">
                        <label for="m_cod" class="col-sm-2 text-right control-label col-form-label">Descripción: </label>
                        <div class="col-sm-12">
