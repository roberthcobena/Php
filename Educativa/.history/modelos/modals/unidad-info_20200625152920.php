        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" id="nuevo_curso" name="nuevo_curso" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label for="m_logo" class="col-sm-3 text-right control-label col-form-label">Portada: </label>
                        <img id="m_logo" name="m_logo" src="" alt="Sin logo" class="img-responsive" height=auto width=30%>
                    </div>
