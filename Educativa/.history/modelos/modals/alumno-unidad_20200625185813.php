                    ...
                    <label for="m_n_unidad" class="col-sm-2 text-left control-label col-form-label">Talleres: </label>
                        <table id="zero_config" class="table table-striped table-bordered text-center">
                            ...
                            <?php 
                                ...
                                $sql = "SELECT * from cursos c, jornadas j, alumnos a, taller t, tema te, unidad u WHERE a.alum_seccion=$id AND c.est_curso!='' AND c.jornada=j.id_seccion AND a.alum_seccion=c.id_curso AND t.curs_taller=c.id_curso AND te.id_tema=t.tema_taller AND te.Id_unidad=u.id_unidad ORDER BY c.nom_curso DESC";
