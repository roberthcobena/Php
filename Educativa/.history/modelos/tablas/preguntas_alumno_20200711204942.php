    ...
    <form class="form-horizontal" method="post" id="finTaller" name="finTaller" enctype="multipart/form-data">
        ...
        <?php
            ...
            <!-- cambiar por selects -->                
                ...
                <input type="hidden" class="form-control" id="id_pregunta" value="<?php echo $id; ?>" name="id_pregunta" readonly="">
                <select class="mi-selector form-control" id="pregunta<?php echo $contador; ?>" name="pregunta<?php echo $contador; ?>" style="width: 100%;" required>
