...
function funcionando2() {
    var fecha2 = $("#inicia").val();
    var inicio2 = new Date(fecha2);
    // obtenemos la fecha actual
    var actual2 = new Date().getTime();
    // obtenemos la diferencia entre la fecha actual y la de inicio
    var diff2 = new Date(actual2 - inicio2);
    var result2 = LeadingZero2(diff2.getUTCMinutes());  
...
function LeadingZero2(Time) {
    return (Time < 10) ? "0" + Time : +Time;
}


function tiempolimite2() {
//TALLER Y CURSO       
