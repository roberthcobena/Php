...
function tiempolimite() {
    if (confirm("El tiempo se acabó")) {
        ...
        //PREGUNTAS
        var id_curso = $("#pregu1").val();
        var id_curso = $("#pregu2").val();
        var id_curso = $("#pregu3").val();
        var id_curso = $("#pregu4").val();
        var id_curso = $("#pregu5").val();
        var id_curso = $("#pregu6").val();
        var id_curso = $("#pregu7").val();
        var id_curso = $("#pregu8").val();
        var id_curso = $("#pregu9").val();
        var id_curso = $("#pregu10").val();
