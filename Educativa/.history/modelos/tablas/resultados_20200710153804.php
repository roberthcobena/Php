<?php    
	...
	if($action == 'ajax'){
		...
		$sWhere = " WHERE p.est_pregu!='' AND p.id_taller=$id_taller AND p.id_pregunta=r.id_pregunta AND r.id_alumno=a.alum_id AND a.alum_usu=u.id_usuario AND u.id_usuario=du.id_usuario AND at.id_taller=t.id_taller AND at.id_alumno=u.id_usuario";
