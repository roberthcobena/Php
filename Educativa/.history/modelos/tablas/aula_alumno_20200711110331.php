        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php //Estado para el alumno
                    $sql3 = "SELECT * FROM alumno_taller a WHERE a.id_alumno = " . $id_al . " AND a.id_taller= " . $id ." AND a.est_taller=1";
                    if ($result = mysqli_query($con, $sql3)) {
                        $row_cnt = mysqli_num_rows($result);
                        if ($row_cnt > 0) {
                            $query3 = mysqli_query($con, $sql3);
                            while ($row_cursos = mysqli_fetch_array($query3)) {
                                printf($row_cursos['est_taller'] . "; ");
                            }
                        } else {
                            printf("<b>Aún no lo rindes perro</b>\n", $row_cnt);
                        }
                    }                    
                ?></td>
