<?php    
	...
	if($action == 'ajax'){
	    ...
	    $sTable = "doc_curso dc, docentes d, cursos c, jornadas j, alumnos a";
		$sWhere = "";
		$sWhere.=" WHERE d.id_usuario= $id AND dc.id_docente=d.id_docente AND c.est_curso!='' AND c.jornada=j.id_seccion AND a.alum_seccion=c.id_curso";
	if ( $_GET['q'] != "" ){
