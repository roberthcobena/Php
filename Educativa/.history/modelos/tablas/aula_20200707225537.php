<?php    
	...
	if($action == 'ajax'){
		...
		$sWhere = "";
		$sWhere.=" WHERE c.id_curso=$id_curso AND dc.id_usuario=$id_docen AND t.curs_taller=te.id_tema AND te.Id_unidad=u.id_unidad AND c.jornada=j.id_seccion AND t.curs_taller=c.id_curso AND c.id_curso=dc.id_curso AND c.est_curso!='' AND t.esta_taller!=''";
	if ( $_GET['q'] != "" ){
