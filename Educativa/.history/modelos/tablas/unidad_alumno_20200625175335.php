<?php    
	...
	if($action == 'ajax'){
	    ...
	    $sTable = "cursos c, jornadas j, alumnos a, taller t";
		$sWhere = "";
		$sWhere.=" WHERE c.est_curso!='' AND c.jornada=j.id_seccion AND a.alum_seccion=c.id_curso AND t.curs_taller=c.id-curso";
	if ( $_GET['q'] != "" ){
