<?php    
	...
	if($action == 'ajax'){
	    ...
	    $sTable = "cursos c, doc_curso dc, taller t, jornadas j";
		$sWhere = "";
		$sWhere.=" WHERE c.id_curso=$id_curso AND dc.id_docente=$id_docen AND c.jornada=j.id_seccion AND t.curs_taller=c.id_curso AND c.id_curso=dc.id_curso AND c.est_curso!='' AND t.esta_taller!=''";
	if ( $_GET['q'] != "" ){
