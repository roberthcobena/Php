...
<table id="zero_config" class="table table-striped table-bordered text-left">
    ...
    ?>
        <tr>
            ...
            <td><?php 
                $respuesta_dada="";
                $sql2 = "SELECT * FROM respuesta r, alumnos a WHERE r.id_alumno=a.alum_id AND a.alum_usu = " . $id_al . " AND r.id_pregunta= " . $row_e['id_pregunta'] ." ";
            ...
            <td><?php 
                ...
                if ($result = mysqli_query($con, $sql2)) {
                    ...
                    if (empty($row_cnt)) {
                        ...
                        while ($row_preg2 = mysqli_fetch_array($query3)) {
                            if ($row_preg2 ['resp_alumno'] == $row_e['opc_correcta']) {
                                $corec="Si";                                
                            }
                            printf("<b>" ."Correcta:" . $row_e['opc_correcta'] ." Dada". $row_preg2 ['resp_alumno'] . " Acierto " . $corec . "</b>");
                        }                            
                    }
                }       
                ?>
