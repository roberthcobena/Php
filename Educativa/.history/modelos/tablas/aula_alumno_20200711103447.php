<?php    
	...
	if($action == 'ajax'){
        ...
        $sTable = "taller t, tema e, unidad u, cursos c, alumno_taller al, usuario us";
		$sWhere = "";
		$sWhere.=" WHERE t.esta_taller!='' AND al.est_taller!='' AND al.id_taller=t.curs_taller AND al.id_alumno = us.id_usuario AND u.id_unidad=e.id_unidad AND e.id_tema=t.tema_taller AND t.curs_taller=c.id_curso AND c.id_curso=$id_curso";
	if ( $_GET['q'] != "" ){
