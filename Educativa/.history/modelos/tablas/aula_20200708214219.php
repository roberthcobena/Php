            ...
            <tr>
                ...
                <td style="text-align: center; white-space: nowrap;">
                    <?php
                        if ($estado==1) {                        
                    ?>
                        <button type="button" class="btn btn-success" title='Detalles' onclick="detalles('<?php echo $id;?>');" data-toggle="modal" data-target="#talInfo"><i class="nav-icon fas fa-edit"></i> Gestionar </button>                    
                    <?php
                        } else ($estado==2) {
                    ?>
                        <button type="button" class="btn btn-danger" title='Detalles' onclick="detalles('<?php echo $id;?>');" data-toggle="modal" data-target="#talInfo"><i class="nav-icon fas fa-check"></i> Ver resultados</button>                        
                    <?php
                        }
                    ?>
