                        ...
                        if ($row_cnt > 0) {
                            ...
                            while ($row_cursos = mysqli_fetch_array($query3)) {
                                if ($row_cursos['est_taller']==1) {
                                    printf("<a href='realizar_taller.php?id_taller=<?php echo $id;?>' class='btn btn-success' title='Realizar taller'><i class='nav-icon fas fa-edit'> Realizar</i></a>" .$row_cursos['est_taller'] . '; ');
                                }
