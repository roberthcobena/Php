                ...
                <td><?php //Estado para el alumno
                    ...
                    if ($result = mysqli_query($con, $sql3)) {
                        ...
                        if ($row_cnt > 0) {
                            ...
                            while ($row_taller = mysqli_fetch_array($query3)) {
                                if ($row_taller['est_taller']==1) {
                                    printf("<a href='realizar_taller.php?id_taller=<?php echo $id;?>' class='btn btn-success' title='Realizar taller'><i class='nav-icon fas fa-edit'> Realizar</i></a>" .$row_taller['est_taller'] . '; ');
                                }

                            }
                        } else {
                            printf("<b>Pendiente</b>\n", $row_cnt);
                        }
                    }                    
                ?></td>
