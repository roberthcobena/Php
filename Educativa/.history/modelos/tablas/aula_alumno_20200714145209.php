<?php    
	...
	if($action == 'ajax'){
		...
		$sWhere = "";
		$sWhere.=" WHERE t.esta_taller!='2' AND u.id_unidad=e.id_unidad AND e.id_tema=t.tema_taller AND t.curs_taller=c.id_curso AND c.jornada=j.id_seccion AND c.id_curso=$id_curso";
	if ( $_GET['q'] != "" ){
