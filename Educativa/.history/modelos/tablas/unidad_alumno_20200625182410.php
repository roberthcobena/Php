    ...
    <table id="zero_config" class="table table-striped table-bordered text-center">       
        ...
        <tbody>
            <?php
                ...
                <input type="hidden" value="<?php echo $id;?>" id="id_unidad<?php echo $id_unidad;?>">	
                <input type="hidden" value="<?php echo $cod;?>" id="cod<?php echo $id_unidad;?>">	
                <input type="hidden" value="<?php echo $curso;?>" id="curso<?php echo $id_unidad;?>">	
                <input type="hidden" value="<?php echo $seccion;?>" id="seccion<?php echo $id_unidad;?>">	
                <input type="hidden" value="<?php echo $jornada;?>" id="jornada<?php echo $id_unidad;?>">	
                <input type="hidden" value="<?php echo $estado;?>" id="estado<?php echo $id_unidad;?>">	               
            <tr>
                <td><h2><?php echo $n_unidad; ?></h2></td>
            </tr>
            <tr>
                <td>
                    <a href="#" title='Detalles de unidad' onclick="obtener_datos('<?php echo $id_unidad;?>');" data-toggle="modal" data-target="#TodoUnidad">
