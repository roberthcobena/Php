    ...
    <?php
        ...
        <tr>
            ...
            <td style="text-align: center;">
                <?php
                    $aciertos=intval('');                                        
                    if ($row_p1= mysqli_query($con, $sql2)) {
                        $row_cntE = mysqli_num_rows($row_p1);
                        if ($row_cntE > 0) {
                            $row_p= mysqli_fetch_array($query2);
                            $sql_aciertos   = mysqli_query($con, "SELECT count(*) AS numrows FROM respuesta r, pregunta p WHERE r.id_pregunta=p.id_pregunta AND p.id_taller=" . $row_p['id_taller'] . " AND r.resp_alumno=" . $row_p['opc_correcta'] . " AND r.id_alumno=" . $row_e['alum_id']);                       
