...
<table id="zero_config" class="table table-striped table-bordered text-left">
    ...
    ?>
        <tr>
            ...
            <td><?php 
                    if ($row_preg ['resp_alumno']==$op_c) {
                        $corec="Si";
                        ++$nota;                                                        
                    }elseif ($row_preg ['resp_alumno']!=$op_c){
                        $corec="No";
                    }elseif(empty($row_preg ['resp_alumno'])){
                        $corec="No Contestó";                        
                    }
                    printf("<b>" . $corec . "</b>");
                ?>
        ...
        <tfoot>
            <tr>
                <th colspan="9" style="text-align: right;">NOTA OBTENIDA: <?php echo $nota?></th>
            </tr>      
        </tfoot>
    </tbody>
</table>
