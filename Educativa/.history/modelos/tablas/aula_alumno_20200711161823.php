        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php
                    $msg_time="";                                         
                    $nota="";
                    $sql2 = "SELECT * FROM alumno_taller a WHERE a.id_alumno = " . $id_al . " AND a.id_taller= " . $id ." AND a.fin_taller IS NOT NULL AND a.est_taller=2";
                    if ($result = mysqli_query($con, $sql2)) {
                        $row_cnt = mysqli_num_rows($result);
                        if (empty($row_cnt)) {
                                printf("<b>Realizado</b>" . $id_al , $row_cnt);
                        }else{                        
                            printf("<b>Pendiente</b>" . $id_al, $row_cnt);
                            }                                                    
                    }                    
                ?></td>
                <td><?php                                         
