        ...
        <tr>
            ...
            <td style="text-align: center;">
                <?php
                    ...
                    $sql_aciertos   = mysqli_query($con, "SELECT count(*) AS numrows FROM pregunta p, respuesta r WHERE  p.id_taller=" . $row_['id_taller'] . " AND r.id_alumno=" . $row_e['alum_id'] . " AND r.resp_alumno=" . $row_p['opc_correcta'] . " AND r.id_pregunta=p.id_pregunta");                       
