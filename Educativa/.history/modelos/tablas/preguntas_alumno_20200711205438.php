    ...
    <form class="form-horizontal" method="post" id="finTaller" name="finTaller" enctype="multipart/form-data">
        ...
        <?php
            ...
            <!-- cambiar por selects -->                
                ...
                <input type="hidden" class="form-control" id="id_pregunta<?php echo $contador; ?>" name="id_pregunta<?php echo $contador; ?>" value="<?php echo $id; ?>"  readonly="">
                <select class="mi-selector form-control" id="respuesta<?php echo $contador; ?>" name="respuesta<?php echo $contador; ?>" style="width: 100%;" required>
