...
<div class="card-body table-responsive p-0">
    ...
    <?php
        ...
        <div class="form-group row">
            <label for="pregunta<?php echo $id; ?>" class="col-sm-3 text-right control-label col-form-label"><?php echo $pregunta; ?> </label>
            <div class="col-sm-9">

            <!-- cambiar por selects -->
                <input type="radio" id="opcion_1_pregunta_<?php echo $id; ?>" name="opcion_1_pregunta<?php echo $id; ?> " value="<?php echo $op1; ?>">
                <label for="opcion_1_pregunta_<?php echo $id; ?>"><?php echo $op1; ?></label><br>

                <input type="radio" id="opcion_2_pregunta_<?php echo $id; ?>" name="opcion_2_pregunta<?php echo $id; ?> " value="<?php echo $op2; ?>">
                <label for="opcion_2_pregunta_<?php echo $id; ?>"><?php echo $op2; ?></label><br>                

                <input type="radio" id="opcion_3_pregunta_<?php echo $id; ?>" name="opcion_3_pregunta<?php echo $id; ?> " value="<?php echo $op3; ?>">
                <label for="opcion_3_pregunta_<?php echo $id; ?>"><?php echo $op3; ?></label><br>                

                <input type="radio" id="opcion_4_pregunta_<?php echo $id; ?>" name="opcion_4_pregunta<?php echo $id; ?> " value="<?php echo $op4; ?>">
                <label for="opcion_4_pregunta_<?php echo $id; ?>"><?php echo $op4; ?></label><br>                                
            </div>
        </div>
        <?php 
        }
