    ...
    <table class="table table-hover text-nowrap">
        ...
        <tbody>
            <?php
                ...
                <input type="hidden" value="<?php echo $curso;?>" id="nombre<?php echo $id;?>">	
                <input type="hidden" value="../app/<?php echo $seccion;?>" id="logo<?php echo $id;?>">	
                <input type="hidden" value="<?php echo $estado;?>" id="estado<?php echo $id;?>">	
            <tr>
                <td><?php echo $contador;?></td>
                <td><?php echo $curso;?></td>        
                <td style="text-align: center;"><img src="../app/<?php echo $seccion;?>" alt="Sin logo" height=auto width=50%></td>        
