...
<div class="card-body table-responsive p-0">    
    <table id="zero_config" class="table table-striped table-bordered text-center">       
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <a href="#" class='btn btn-default' title='Detalles de unidad' onclick="obtener_datos('<?php echo $id_locacion;?>');" data-toggle="modal" data-target="#editarRbs">
                        <img src="../<?php echo $portada?>" alt="" height=auto width=50%>    
                        <strong><i><?php echo $nombre_locacion; ?></i></strong>
                    </a>
                </td>
