    ...
    <table id="zero_config" class="table table-striped table-bordered text-center">       
        ...
        <tbody>
            <?php
                ...
                <input type="hidden" value="<?php echo $n_unidad;?>" id="n_unidad<?php echo $id_unidad;?>">	
                <input type="hidden" value="<?php echo $n_descri;?>" id="n_descri<?php echo $id_unidad;?>">	
            ...
            <tr>
                <td>
                    <a href="#" title='Detalles de unidad' onclick="detalles('<?php echo $id_unidad;?>');" data-toggle="modal" data-target="#TodoUnidad">
