        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center; white-space: nowrap;">
                    ...
                    ?>
                        <button type="button" class="btn btn-success" title='Detalles' onclick="detalles('<?php echo $id;?>');" data-toggle="modal" data-target="#talInfo"><i class="nav-icon fas fa-edit"></i> Ver resultados</button>                        
                    <?php
                        }else {
                    ?>
