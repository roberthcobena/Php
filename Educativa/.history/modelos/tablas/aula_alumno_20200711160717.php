        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php
                    $msg_time="";                                         
                    $nota="";
                    $sql2 = "SELECT * FROM alumno_taller a WHERE a.id_alumno = " . $id_al . " AND a.id_taller= " . $id ." AND a.fin_taller!=NULL";
                    if ($result = mysqli_query($con, $sql2)) {
                        $row_cnt = mysqli_num_rows($result);
                        if (empty($row_cnt)) {
                                printf("<b>PENDIENTE</b>" , $row_cnt);
                        }else{                        
                            $sql_q = "SELECT * FROM alumno_taller a WHERE a.id_alumno = " . $id_al . " AND a.id_taller= " . $id ."";
                            $query3 = mysqli_query($con, $sql_q);
