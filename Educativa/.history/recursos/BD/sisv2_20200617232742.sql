...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-06-2020 a las 23:26:22
...
CREATE TABLE `cargos` (
  ...
  `nom_cargo` varchar(200) NOT NULL,
  `des_cargo` varchar(200) NOT NULL,
...
CREATE TABLE `cursos` (
  ...
  `sec_curso` varchar(200) NOT NULL,
...
INSERT INTO `cursos` (`id_curso`, `nom_curso`, `sec_curso`, `jornada`, `est_curso`) VALUES
(1, '7mo', 'A', 1, 1),
(2, '7mo', 'B', 2, 1);
...
CREATE TABLE `datos_usuarios` (
  ...
  `nomb_user` varchar(200) NOT NULL,
  `apell_user` varchar(200) NOT NULL,
  `telf_user` varchar(200) DEFAULT NULL,
  `correo_user` varchar(200) DEFAULT NULL,
...
CREATE TABLE `docentes` (
  ...
  `id_usuario` int(11) NOT NULL,
  `doc_titulo` varchar(50) DEFAULT NULL,
...
CREATE TABLE `jornadas` (
  ...
  `nom_seccion` varchar(200) NOT NULL,
...
CREATE TABLE `respuesta` (
  ...
  `resp_alumno` varchar(50) NOT NULL,
...
CREATE TABLE `taller` (
  ...
  `nom_taller` varchar(200) NOT NULL,
...
INSERT INTO `taller` (`id_taller`, `tema_taller`, `curs_taller`, `nom_taller`, `esta_taller`) VALUES
(1, 1, 1, 'Taller 1', 1);
...
CREATE TABLE `tema` (
  ...
  `te_nombre` varchar(200) NOT NULL,
  `te_descripcion` text DEFAULT NULL,
...
CREATE TABLE `unidad` (
  ...
  `uni_descripcion` text DEFAULT NULL,
...
INSERT INTO `unidad` (`id_unidad`, `uni_nombre`, `uni_descripcion`, `uni_est`) VALUES
(1, 'El cuerpo humano', 'Todo lo relacionado al campo Antropológico', 1),
(2, 'El reino animal', 'Todo lo relacionado con Zoología', 1),
(3, 'El reino plantae', 'Todo lo relacionado con Botánica', 1);
