...
<body>
   ...
   <form method="post" accept-charset="utf-8" name="nuevoUsuario" autocomplete="off" role="form" >
	  ...
	  <button type="submit" class="button" name="registro" id="submit">REGISTRARME</button></br></br>
