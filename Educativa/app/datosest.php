<?php   
    ...
    $usuario="Administrador | Estudiantes Registrados";
?>
<!DOCTYPE html>
...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Estudiantes registrados</h4>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?php
                                include("../modelos/modals/est-info.php");
                                ?>
                                <form class="form-horizontal" role="form" id="unidades">
                                    <center>
                                        <div lass="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control" id="q" placeholder="Ingrese nombre o apellido del estudiante" onkeyup='load(1);'>
                                            </div>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script type="text/javascript" src="../controladores/js/est.js"></script> 
