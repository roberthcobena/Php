<?php   
    ...
    $usuario="Administrador | Usuarios Registrados";
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Docentes registrados</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool btn-primary" title='Añadir' data-toggle="modal" data-target="#docNew"><i class="nav-icon fas fa-plus"></i> Añadir </button>
                            ...
                            <div class="card-body">
                                <?php
                                include("../modelos/modals/doc-new.php");
                                include("../modelos/modals/doc-info.php");
                                ?>
                                <form class="form-horizontal" role="form" id="usuarios">
                                    <center>
                                        <div lass="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control" id="q" placeholder="Ingrese nombre o apellido o cedula del docente" onkeyup='load(1);'>
                                            </div>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script type="text/javascript" src="../controladores/js/doc.js"></script> 
