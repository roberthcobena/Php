...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Talleres creados</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                include("../modelos/modals/taller-infoges.php");
                                ?>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script type="text/javascript" src="../controladores/js/taller.js"></script> 
    ...
    <script src="../recursos/app/vendor/datetimepicker/js/moment.min.js"></script>
