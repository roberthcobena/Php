<?php   
    ...
    while ($row2 = mysqli_fetch_array($query2)) {
        ...
        $fech_completa=date('d-M-Y H:i:s',strtotime($row2['ini_taller']));               
        $fech_inicio=date('d-M-Y',strtotime($row2['ini_taller']));
        $hora_inicio=date('H:i:s',strtotime($row2['ini_taller']));
    }
    
    $usuario= $taller ." | " . $estudiante;
?>
<!DOCTYPE html>
<html dir="ltr" lang="es">
  ...
  <head>
    ...
    <link href="../../recursos/app/vendor/jquery-steps/jquery.steps.css" rel="stylesheet">
    <link href="../../recursos/app/vendor/jquery-steps/steps.css" rel="stylesheet">
...
<body oncontextmenu="return false">    
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group row">
                                                <h4>Hora de inicio: <?php echo $fech_inicio . " A las " . $hora_inicio ;  ?></h4>
                                                <input type="hidden" value="<?php echo $fech_completa;?>" id="inicio">
                                            </div>
    ...
    <script src="../../recursos/app/vendor/jquery-steps/build/jquery.steps.min.js"></script>
    <script src="../../recursos/app/vendor/jquery-validation/dist/jquery.validate.min.js"></script>
