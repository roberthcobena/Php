<?php   
    ...
    $usuario="Estudiante | Sistema académico";
?>
<!DOCTYPE html>
<html lang="es">
                    ...
                    <div class="card">
                            <div class="card-body">
                                <?php
                                    ...
                                    $numrows = $row['numrows'];$sql="SELECT * FROM  $sTable $sWhere";
                                    $query = mysqli_query($con, $sql);
                                ?>
                                <h5 class="card-title">Docentes: <?php echo $numrows;?></h5>
                                <table>
                                    <tr>
                                    <?php                
                        ...
                        <div class="card">
                            <div class="card-body">
                                <?php
                                    ...
                                    $query = mysqli_query($con, $sql);
                                ?>
                                <h5 class="card-title">Estudiantes: <?php echo $numrows;?></h5>
                                <table>
                                    <tr>
                                    <?php                
                                        while ($row = mysqli_fetch_array($query)) {
