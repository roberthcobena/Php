...
<body>    
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Inscripcion</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">                            
                        <div class="card">                        
                            ...
                            <div class="card-tools">
                                ...
                                <button type="button" class="btn btn-tool btn-primary" title='Añadir' data-toggle="modal" data-target="#matriNew"><i class="nav-icon fas fa-plus"></i> Matricularse </button>
                            ...
                            <div class="card-body">
                                ...
                                <center>
                                    <div class="form-group row"> 
                                        ...
                                        <div class="col-md-7">
                                            <input type="text" class="form-control" id="q" placeholder="Código o nombre de curso" onkeyup='load(1);'>
                                        </div>
                                        <div class="col-md-3">                      
                                            <span id="loader"></span>
                                        </div>                        
    ...
    <script type="text/javascript" src="../../controladores/js/curso_alumno.js"></script>    
