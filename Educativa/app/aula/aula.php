...
<body oncontextmenu="return false">    
    ...
    <div id="main-wrapper">
        <?php
        include "../../vistas/alumno/header_2.php";
        ?>
                    ...
                    <div class="col-12 d-flex no-block align-items-center">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="estudiante.php">Aula</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table>
                                    ...
                                    ?>
                                        <th><?php echo $tit_docente ." " . $ape_docente . " " . $nom_docente;?></th>
                                    </tr>
                                    <?php }?>
                                </table>
                            </div>
    ...
    <script type="text/javascript" src="../../controladores/js/aula_alumno.js"></script>
