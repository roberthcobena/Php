...
<body>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?php
                                include("../modelos/modals/user-new.php");
                                include("../modelos/modals/user-info.php");
                                ?>
                                <form class="form-horizontal" role="form" id="usuarios">
                                    <center>
                                        <div lass="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control" id="q" placeholder="Ingrese nombre o apellido del usuario" onkeyup='load(1);'>
                                            </div>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script type="text/javascript" src="../controladores/js/user.js"></script> 
    ...
    <script type="text/javascript">
        //$('.m_telf').mask('(00)00000000', {'translation': {0: {pattern: /[0-9*]/}}});
    </script>
