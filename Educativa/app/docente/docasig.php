<?php   
    ...
    $usuario="Director | Asignacion de Cursos";
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Asignacion de Cursos</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool btn-primary" title='Añadir' data-toggle="modal" data-target="#asigNew"><i class="nav-icon fas fa-plus"></i> Añadir </button>
                            ...
                            <div class="card-body">
                                <?php
                                include("../../modelos/modals/asig-new.php");
                                include("../../modelos/modals/asig-info.php");
                                ?>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script type="text/javascript" src="../../controladores/js/docasig.js"></script> 
