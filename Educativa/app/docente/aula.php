            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title"><?php echo $curso . " (".$sec.") -Jornada ". $jornada;  ?></h4>
                    ...
                    <div class="col-md-10">
                        <div class="card">
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool btn-primary" title='Añadir' data-toggle="modal" data-target="#talNew"><i class="nav-icon fas fa-plus"></i> Añadir taller</button>
                            ...
                            <div class="card-body">
                                <?php
                                    include("../../modelos/modals/doc_taller-new.php");
                                    include("../../modelos/modals/doc_taller-info.php");
                                    include("../../modelos/modals/doc_taller-infoges.php");
                                    ?>
                                    <form class="form-horizontal" role="form" id="usuarios">                                    
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control" id="q" placeholder="Ingrese nombre del taller" onkeyup='load(1);'>
