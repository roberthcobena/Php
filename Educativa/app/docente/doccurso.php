...
<body>    
                    ...
                    <div class="col-12">                            
                        <div class="card">                        
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool btn-primary" title='Añadir' data-toggle="modal" data-target="#cursoNew"><i class="nav-icon fas fa-plus"></i> Añadir </button>
                            ...
                            <div class="card-body">
                                ...
                                <center>
                                    <div class="form-group row"> 
                                        ...
                                        <div class="col-md-7">
                                            <input type="text" class="form-control" id="q" placeholder="Ingrese nombre o código del curso" onkeyup='load(1);'>
                                        </div>
                                        <div class="col-md-3">                      
                                            <span id="loader"></span>
                                        </div>                        
    ...
    <script type="text/javascript" src="../../controladores/js/doccur.js"></script>    
