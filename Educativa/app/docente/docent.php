<?php   
    ...
    $usuario="Director | Administracion de docentes";
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                include("../../modelos/modals/ddoc-info.php");
                                ?>
                                <form class="form-horizontal" role="form" id="usuarios">
                                    <center>
                                        <div lass="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control" id="q" placeholder="Ingrese nombre o apellido del docente" onkeyup='load(1);'>
                                            </div>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script type="text/javascript" src="../../controladores/js/docent.js"></script> 
