<?php	
	...
	$usuario="Administrador | Años Lectivos";
?>
<!DOCTYPE html>
...
<body>    
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Año Lectivo</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="admin.php">Inicio</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Años Lectivos</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">                            
                        <div class="card">                        
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool btn-primary" title='Añadir' data-toggle="modal" data-target="#añoNew"><i class="nav-icon fas fa-plus"></i> Añadir </button>
                            ...
                            <div class="card-body">
                                <?php
                                    include("../modelos/modals/año-new.php");
                                    include("../modelos/modals/año-info.php");                  
                                ?>
                                
                                <form class="form-horizontal" role="form" id="años">
                                <center>
                                    <div style="display:none"  class="form-group row"> 
                                        <label for="q" class="col-md-2 control-label">Buscar</label>                                     
                                        <div class="col-md-7">
                                            <input type="text" class="form-control" id="q" placeholder="Ingrese código del año" onkeyup='load(1);'>
                                        </div>
                                        <div class="col-md-3">                      
                                            <span id="loader"></span>
                                        </div>                        
    ...
    <script type="text/javascript" src="../controladores/js/años.js"></script>    
    ...
    $(function () {
        ...
        $("#datetimepicker9").attr("readonly","readonly");
