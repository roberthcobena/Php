<?php   
    ...
    $usuario="Administrador | Unidades";
?>
<!DOCTYPE html>
...
<body>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool btn-primary" title='Añadir' data-toggle="modal" data-target="#uniNew"><i class="nav-icon fas fa-plus"></i> Añadir </button>
                            ...
                            <div class="card-body">
                                <?php
                                include("../modelos/modals/unidad-new.php");
                                include("../modelos/modals/unidad-info.php");
                                ?>
                                <form class="form-horizontal" role="form" id="unidades">
                                    <center>
                                        <div lass="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control" id="q" placeholder="Ingrese nombre de la unidad" onkeyup='load(1);'>
                                            </div>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script type="text/javascript" src="../controladores/js/unidad.js"></script> 
